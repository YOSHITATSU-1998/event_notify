    ...
    <div className="min-h-screen bg-gray-100 py-6 px-4">
      <div className="max-w-xl mx-auto bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mb-6 text-center animate-fade-in">
          <Link
            href="/help/install"
            className="inline-flex items-center gap-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 hover:text-blue-800 text-xs font-bold px-4 py-2 rounded-full transition-colors border border-blue-100 shadow-sm"
          >
            <span>📱</span>
            <span>スマホのホーム画面に追加（アプリ化）する</span>
